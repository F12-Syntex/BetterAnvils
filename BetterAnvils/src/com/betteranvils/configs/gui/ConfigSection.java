package com.betteranvils.configs.gui;
...
import com.betteranvils.GUI.GenerateItem;
import com.betteranvils.GUI.PagedItem;
import com.betteranvils.GUI.SpecialItem;
import com.betteranvils.config.Config;
import com.betteranvils.main.BetterAnvils;
import com.betteranvils.utils.Communication;
import com.betteranvils.utils.ComponentBuilder;
import com.betteranvils.utils.Input;
import com.betteranvils.utils.MessageUtils;
import com.betteranvils.utils.Numbers;
...
public class ConfigSection extends ConfigGUI {
	...
	public List<PagedItem> Contents() {
		...
		this.configSection.getKeys(false).forEach(i -> {
			...
			ItemStack section = new ItemStack(Material.valueOf(BetterAnvils.getInstance().configManager.configs.Sections));
			ItemStack ints = new ItemStack(Material.valueOf(BetterAnvils.getInstance().configManager.configs.Numbers));
			ItemStack text = new ItemStack(Material.valueOf(BetterAnvils.getInstance().configManager.configs.Text));
			ItemStack booleanON = new ItemStack(Material.valueOf(BetterAnvils.getInstance().configManager.configs.BooleanON));
			ItemStack booleanOFF = new ItemStack(Material.valueOf(BetterAnvils.getInstance().configManager.configs.BooleanOFF));
			ItemStack lists = new ItemStack(Material.valueOf(BetterAnvils.getInstance().configManager.configs.Lists));
					...
					execution = () -> {
						...
						Communication.applyInput(player, new Input() {
							...
							public void onRecieve(String o) {
								...
								Bukkit.getScheduler().callSyncMethod(BetterAnvils.getInstance(), new Callable<Object>() {
									@Override

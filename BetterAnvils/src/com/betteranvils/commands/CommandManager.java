...
import com.betteranvils.config.Messages;
import com.betteranvils.config.Permissions;
import com.betteranvils.cooldown.CooldownUser;
import com.betteranvils.main.BetterAnvils;
import com.betteranvils.tags.TagFactory;
import com.betteranvils.utils.MessageUtils;
import com.betteranvils.utils.StringMinipulation;

public class CommandManager implements CommandExecutor {

    private ArrayList<SubCommand> commands = new ArrayList<SubCommand>();
    private Messages messages = BetterAnvils.getInstance().configManager.messages;
    private Permissions permissions = BetterAnvils.getInstance().configManager.permissions;
    private Cooldown cooldowns = BetterAnvils.getInstance().configManager.cooldown;
    
    private BetterAnvils plugin;

    //Sub Commands
    public String main = "anvils";
    
    public void setup(BetterAnvils plugin) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        ...
        if (command.getName().equalsIgnoreCase(main)) {
            ...
            if (args.length == 0) {
            	...
            	CooldownUser user = BetterAnvils.getInstance().cooldownManager.getUser(player.getUniqueId());
	...
	public BetterAnvils getPlugin() {
		return plugin;
	}


	public void setPlugin(BetterAnvils plugin) {
		this.plugin = plugin;
	}

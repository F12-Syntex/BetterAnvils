...
import com.betteranvils.placeholder.time.TimeFormater;
...
public class TagFactory{
	...
	public String playerParse(String parser) {
		...
		parser = parser.replace("%prefix%", BetterAnvils.getInstance().configManager.messages.prefix);

...
public class CooldownUser {
	...
	public Integer getTime(String key) {
		if(this.cooldown.containsKey(key)) {
			...
			int timer = BetterAnvils.getInstance().configManager.cooldown.getCooldown(key);
	...
	public void reset(String key) {
		this.cooldown.put(key, BetterAnvils.getInstance().configManager.cooldown.getCooldown(key));
	}
